...
$produkpesan = $koneksi->query("SELECT * FROM invoice where  status='0'");
$jprodukpesan = mysqli_num_rows($produkpesan);
...
<head>
    ...
    <title>TOKO SEHATI | Online Shop</title>
    <!-- Favicon-->
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="index.php">
                            ...
                            <span>Home</span><?php echo "<code> $jprodukpesan Pesanan Menunggu</code>";?>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <a href="jenis.php"><span>DAFTAR JENIS</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="supplier.php"><span>SUPPLIER PRODUK</span></a>
                            </li>
                    ...
                    <li>
                        <a href="semuatransaksi.php" class="menu-toggle">
