...
<table width="100%" cellpadding="0" cellspacing="0" class="table"style="background-image: url('#')">
    ...
    <tr style="border-right:1px #eeeeee; background:#EF4135;color:#ffffff;font-size:16px; padding:5px;text-align:center;">
        <th  style="width: 100%; text-align:center; background:#000;color:#ffffff;" colspan="9">Best Member</th>
    </tr>
    <tr >
        <th width="" align="center" valign="middle">No.</th>
        <th width="" align="center" valign="middle">Nama Member</th>
        <th width="" align="center" valign="middle">Foto Member</th>
        <th width="" align="center" valign="middle">NIK</th>
        <th width="" align="center" valign="middle">Banyak Transaksi</th>
        <th width="" align="center" valign="middle">Alamat</th>
    <br/>
    <br/>
    <?php
    ...
    while($datapost=mysqli_fetch_array($sql)){
        ...
        <td  align="center"><img width="150px" height="150px"  src="../panel_member/images/<?PHP
            $gambar= mysqli_query($koneksi, "Select * FROM member where nik='".$datapost['nik']."'");
            while($pic=mysqli_fetch_array($gambar)){
                if (($datapost['nik'])=='') {
                    echo 'user.png';
