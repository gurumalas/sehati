...
<!--            </div>-->
            ...
            <div class="user">
                ...
                if('location:../index.php'){
                   echo ' <a data-toggle="modal" data-target="#modalLRForm" class="user-profile"  aria-expanded="false"><div><img src="images/user.svg" alt="https://www.flaticon.com/authors/freepik"><div>4</div></div></a>';
                } else{
                    echo '';}
